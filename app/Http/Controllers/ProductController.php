...
class ProductController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        foreach ($products as $product) {
            $product->reviews_average = $product->reviews()->avg('score');
        }
    ...
    public function show(Product $product)
    {
        ...
        $reviews_average = $product->reviews()->avg('score');
        return view('products.show', compact('product','reviews','reviews_average'));
    }
